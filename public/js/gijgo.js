...
gj.dialog.methods = {
    ...
    resizable: function($dialog) {
        ...
        $dialog.append($('<div class="gj-resizable-handle gj-resizable-n"></div>').draggable($.extend(true, {
            horizontal: false
        }, config)));
        $dialog.append($('<div class="gj-resizable-handle gj-resizable-e"></div>').draggable($.extend(true, {
            vertical: false
        }, config)));
        $dialog.append($('<div class="gj-resizable-handle gj-resizable-s"></div>').draggable($.extend(true, {
            horizontal: false
        }, config)));
        $dialog.append($('<div class="gj-resizable-handle gj-resizable-w"></div>').draggable($.extend(true, {
            vertical: false
        }, config)));
...
gj.droppable.methods = {
    ...
    isOver: function($dropEl, mousePosition) {
        ...
        return mousePosition.x > offsetLeft && mousePosition.x < (offsetLeft + $dropEl.outerWidth(true)) && mousePosition.y > offsetTop && mousePosition.y < (offsetTop + $dropEl.outerHeight(true));
    },
...
gj..config = {
    base: {
        ...
        .
         * @additionalinfo If set to string, then the 


          is going to use this string as a url for ajax requests to the server.<br />
         * If set to object, then the 


          is going to use this object as settings for the <a href="http://api.jquery.com/jquery.ajax/" target="_new">jquery ajax</a> function.<br />
         * If set to array, then the 


          is going to use the array as data for rows.
        ...
        /** An array that holds the configurations of each column from the 
        ...
        /** An object that holds the default configuration settings of each column from the 
        ...
        defaultColumnSettings: {
            /** If set to true the column will not be displayed in the 
             ...
             * If the width is undefined the width of the column is not set and depends on the with of the table(
             ...
             * If set to true the user can click the column header and sort the 


              by the column source field.
             ...
             *     });
             * </script>
             * @example Remote.Bootstrap.3 <!-- bootstrap, 
             ...
             *     });
             * </script>
             * @example Remote.Bootstrap.4.Material.Icons <!-- bootstrap4, 
             ...
             *     });
             * </script>
             * @example Remote.Bootstrap.4.FontAwesome <!-- bootstrap4, fontawesome, 
             ...
             * @type object
             * @default undefined
             * @example javascript.configuration <!-- bootstrap, 
             ...
             *     });
             * </script>
             * @example html.configuration <!-- bootstrap, 
             ...
             * <table id="
             ...
             " data-source="/Players/Get" data-ui-library="bootstrap">
             *     <thead>
             *         <tr>
             ...
             *         
             ...
             .reload({ Value1: $('#txtValue1').val(), Value2: $('#txtValue2').val() });
             *     });
             * </script>
             */
            filter: undefined
        ...
        mapping: {
            /** The name of the object in the server response, that contains array with records, that needs to be display in the 
         ...
         * @additionalinfo The css files for Bootstrap or Material Design should be manually included to the page where the 


          is in use.
         * @type (materialdesign|bootstrap|bootstrap4)
         * @default 'materialdesign'
         * @example Material.Design.With.Icons <!-- dropdown, 
         ...
         * The css files for Material Icons, Font Awesome or Glyphicons should be manually included to the page where the 


          is in use.
         * @type (materialicons|fontawesome|glyphicons)
         * @default 'materialicons'
         * @example Font.Awesome <!-- fontawesome, 
         ...
         * If the type is set to multiple the user will be able to select more then one row from the 


         .
         * @type (single|multiple)
         * @default 'single'
         * @example Multiple.Material.Design.Checkbox <!-- checkbox, 
         ...
         *     });
         * </script>
         * @example Multiple.Bootstrap.3.Checkbox <!-- bootstrap, checkbox, 
         ...
         *     });
         * </script>
         * @example Single.Checkbox <!-- checkbox, 
         ...
         * If this setting is set to "checkbox" a column with checkboxes will appear as first row of the 


          and when the user select a row, then this row will be highlighted and the checkbox selected.
         * @type (basic|checkbox)
         * @default "basic"
        ...
        /** When this setting is enabled the content of the 


         will be loaded automatically after the creation of the 
         ...
         *     
         ...
         .reload(); //call .reload() explicitly in order to load the data in the 
         ...
         */
        autoLoad: true,
        /** The text that is going to be displayed if the 
         ...
         * <table id="
         ...
         "></table>
         * <script src="../../dist/modular/


         /js/messages/messages.de-de.js"></script>
         * <script>
         *     $('#
         ...
         * @additionalinfo If you set primary key, we assume that this number is unique for each records presented in the 
         ...
         * @type string
         * @default 'en-us'
         * @example German.Bootstrap.Default <!-- bootstrap, 
         ...
         *     gj.
         ...
         .messages['fr-fr'].DisplayingRecords = 'Mes résultats';
         *     $('#
        ...
        style: {
            wrapper: 'gj--wrapper',
            table: 'gj-gj--md',
            loadingCover: 'gj--loading-cover',
            loadingText: 'gj--loading-text',
            header: {
                cell: undefined,
                sortable: 'gj-cursor-pointer gj-unselectable'
            },
            content: {
                rowSelected: 'gj--md-select'
            }
        },
        icons: {
            asc: '▲',
    ...
    bootstrap: {
        style: {
            wrapper: 'gj--wrapper',
            table: 'gj-gj--bootstrap gj--bootstrap-3 table table-bordered table-hover',
            content: {
                rowSelected: 'active'
            }
        },
    ...
    bootstrap4: {
        style: {
            wrapper: 'gj--wrapper',
            table: 'gj-gj--bootstrap gj--bootstrap-4 table table-bordered table-hover',
            content: {
                rowSelected: 'active'
            }
        },
...
gj..events = {
    /**
     * Event fires before addition of an empty row to the 
     ...
     *     
     ...
     .on('beforeEmptyRowInsert', function (e, $row) {
     *         alert('beforeEmptyRowInsert is fired.');
     *     });
     * </script>
     */
    beforeEmptyRowInsert: function($, $row) {
        return $.triggerHandler('beforeEmptyRowInsert', [$row]);
    },
    /**
     ...
     *     
     ...
     .on('dataBinding', function (e, records) {
     *         alert('dataBinding is fired. ' + records.length + ' records will be loaded in the 
     ...
     * </script>
     */
    dataBinding: function($, records) {
        return $.triggerHandler('dataBinding', [records]);
    },
    /**
     * Event fires after the loading of the data in the 
     ...
     * @param {object} e - event data
     * @param {array} records - the list of records
     * @param {number} totalRecords - the number of the all records that can be presented in the 
     ...
     *     
     ...
     .on('dataBound', function (e, records, totalRecords) {
     *         alert('dataBound is fired. ' + records.length + ' records are bound to the 
     ...
     * </script>
     */
    dataBound: function($, records, totalRecords) {
        return $.triggerHandler('dataBound', [records, totalRecords]);
    },
    /**
     * Event fires after insert of a row in the 
     ...
     *     
     ...
     .on('rowDataBound', function (e, $row, id, record) {
     *         alert('rowDataBound is fired for row with id=' + id + '.');
     *     });
     * </script>
     */
    rowDataBound: function($, $row, id, record) {
        return $.triggerHandler('rowDataBound', [$row, id, record]);
    },
    /**
     * Event fires after insert of a cell in the 
     ...
     *     
     ...
     .on('cellDataBound', function (e, $displayEl, id, column, record) {
     ...
     * </script>
     */
    cellDataBound: function($, $displayEl, id, column, record) {
        return $.triggerHandler('cellDataBound', [$displayEl, id, column, record]);
    },
    /**
     ...
     *     
     ...
     .on('rowSelect', function (e, $row, id, record) {
     *         alert('Row with id=' + id + ' is selected.');
     *     });
     * </script>
     */
    rowSelect: function($, $row, id, record) {
        return $.triggerHandler('rowSelect', [$row, id, record]);
    },
    /**
     ...
     *     
     ...
     .on('rowUnselect', function (e, $row, id, record) {
     *         alert('Row with id=' + id + ' is unselected.');
     *     });
     * </script>
     */
    rowUnselect: function($, $row, id, record) {
        return $.triggerHandler('rowUnselect', [$row, id, record]);
    },
    /**
     * Event fires before deletion of row in the 
     ...
     * <button onclick="
     ...
     .removeRow('1')" class="gj-button-md">Remove Row</button><br/><br/>
     * <table id="
     ...
     *     
     ...
     .on('rowRemoving', function (e, $row, id, record) {
     *         alert('rowRemoving is fired for row with id=' + id + '.');
     *     });
     * </script>
     */
    rowRemoving: function($, $row, id, record) {
        return $.triggerHandler('rowRemoving', [$row, id, record]);
    },
    /**
     ...
     */
    destroying: function($) {
        return $.triggerHandler('destroying');
    },
    /**
     ...
     *     
     ...
     .on('columnHide', function (e, column) {
     *         alert('The ' + column.field + ' column is hidden.');
     *     });
     *     


     .hideColumn('PlaceOfBirth');
     * </script>
     */
    columnHide: function($, column) {
        return $.triggerHandler('columnHide', [column]);
    },
    /**
     ...
     *     
     ...
     .on('columnShow', function (e, column) {
     *         alert('The ' + column.field + ' column is shown.');
     *     });
     *     


     .showColumn('PlaceOfBirth');
     * </script>
     */
    columnShow: function($, column) {
        return $.triggerHandler('columnShow', [column]);
    },
    /**
     * Event fires when 
    ...
    initialized: function($) {
        return $.triggerHandler('initialized');
    },
    /**
     * Event fires when the 
     ...
     * </script>
     */
    dataFiltered: function($, records) {
        return $.triggerHandler('dataFiltered', [records]);
    }
};
/*global gj $*/
gj..methods = {
    ...
    getConfig: function(jsConfig, type) {
        ...
        gj..methods.setDefaultColumnConfig(config.columns, config.defaultColumnSettings);
        return config;
    },
    ...
    getHTMLConfig: function() {
        ...
        this.find('thead > tr > th').each(function() {
            ...
            if (config.events) {
                config.events = gj..methods.eventsParser(config.events);
            }
    ...
    initialize: function($) {
        var data = $.data(),
            $wrapper = $.parent('div[data-role="wrapper"]');
        gj..methods.localization(data);
        if ($wrapper.length === 0) {
        ...
        if (data.minWidth) {
            $.css('min-width', data.minWidth);
        }
        if (data.fontSize) {
            $.css('font-size', data.fontSize);
        }
        if (data.headerRowHeight === 'autogrow') {
            $.addClass('autogrow-header-row');
        }
        if (data.bodyRowHeight === 'fixed') {
            $.addClass('fixed-body-rows');
        }
        $.addClass(data.style.table);
        if ('checkbox' === data.selectionMethod) {
            data.columns.splice(gj..methods.getColumnPositionNotInRole($), 0, {
                title: '',
                ...
                events: {
                    click: function(e) {
                        gj..methods.setSelected($, e.data.id, $(this).closest('tr'));
                    }
                },
                headerCssClass: 'gj--select-all',
                stopPropagation: true
            });
        }
        if ($.children('tbody').length === 0) {
            $.append($('<tbody/>'));
        }
        gj..methods.renderHeader($);
        gj..methods.appendEmptyRow($, '&nbsp;');
        gj..events.initialized($);
    },
    localization: function(data) {
        if (!data.notFoundText) {
            data.notFoundText = gj..messages[data.locale].NoRecordsFound;
        }
    },
    renderHeader: function($) {
        ...
        for (i = 0; i < columns.length; i += 1) {
            ...
            if ('checkbox' === data.selectionMethod && 'multiple' === data.selectionType && 'checkbox' === columns[i].type && 'selectRow' === columns[i].role) {
                ...
                if (columns[i].sortable) {
                    ...
                    $title.on('click', gj..methods.createSortHandler($, columns[i]));
                }
            }
            if (columns[i].hidden) {
                $cell.hide();
    ...
    createSortHandler: function($, column) {
        return function() {
            var data, params = {};
            if ($.count() > 0) {
                data = $.data();
    ...
    updateHeader: function($) {
        ...
        $.find('thead tr th [data-role="sorticon"]').remove();
        if (sortBy) {
            position = gj..methods.getColumnPosition($.data('columns'), sortBy);
            if (position > -1) {
                $cellTitle = $.find('thead tr th:eq(' + position + ') div[data-role="title"]');
    ...
    useHtmlDataSource: function($, data) {
        var dataSource = [],
            i, j, $cells, record,
            $rows = $.find('tbody tr[data-role != "empty"]');
    ...
    startLoading: function($) {
        ...
        top = Math.abs($.parent().offset().top - $tbody.offset().top);
        $cover = $('<div data-role="loading-cover" />').addClass(data.style.loadingCover).css({
            width: width,
            height: height,
            top: top
        });
        $loading = $('<div data-role="loading-text">' + gj..messages[data.locale].Loading + '</div>').addClass(data.style.loadingText);
        $loading.insertAfter($);
        $cover.insertAfter($);
        $loading.css({
    ...
    stopLoading: function($) {
        $.parent().find('div[data-role="loading-cover"]').remove();
        $.parent().find('div[data-role="loading-text"]').remove();
    },
    appendEmptyRow: function($, caption) {
        ...
        $cell.attr('colspan', gj..methods.countVisibleColumns($));
        $wrapper = $('<div />').html(caption || data.notFoundText);
        $cell.append($wrapper);
        $row.append($cell);
        gj..events.beforeEmptyRowInsert($, $row);
        $.append($row);
    },
    autoGenerateColumns: function($, records) {
        var names, value, type, i, data = $.data();
        data.columns = [];
        if (records.length > 0) {
            ...
            gj..methods.setDefaultColumnConfig(data.columns, data.defaultColumnSettings);
        }
        gj..methods.renderHeader($);
    },
    loadData: function($) {
        ...
        data = $.data();
        records = $.getAll();
        gj..events.dataBinding($, records);
        recLen = records.length;
        gj..methods.stopLoading($);
        if (data.autoGenerateColumns) {
            gj..methods.autoGenerateColumns($, records);
        }
        $tbody = $.children('tbody');
        if ('checkbox' === data.selectionMethod && 'multiple' === data.selectionType) {
            $.find('thead input[data-role="selectAll"]').prop('checked', false);
        }
        ...
        for (i = 0; i < rowCount; i++) {
            if (i < recLen) {
                $row = $rows.eq(i);
                gj..methods.renderRow($, $row, records[i], i);
            } else {
        ...
        for (i = rowCount; i < recLen; i++) {
            gj..methods.renderRow($, null, records[i], i);
        }
        gj..events.dataBound($, records, data.totalRecords);
    },
    getId: function(record, primaryKey, position) {
        return (primaryKey && record[primaryKey]) ? record[primaryKey] : position;
    },
    renderRow: function($, $row, record, position) {
        ...
        id = gj..methods.getId(record, data.primaryKey, (position + 1));
        $row.attr('data-position', position + 1);
        if (data.selectionMethod !== 'checkbox') {
            $row.on('click', gj..methods.createRowClickHandler($, id));
        }
        for (i = 0; i < data.columns.length; i++) {
            if (mode === 'update') {
                $cell = $row.find('td:eq(' + i + ')');
                gj..methods.renderCell($, $cell, data.columns[i], record, id);
            } else {
                $cell = gj..methods.renderCell($, null, data.columns[i], record, id);
                $row.append($cell);
            }
        }
        gj..events.rowDataBound($, $row, id, record);
    },
    renderCell: function($, $cell, column, record, id, mode) {
        var $displayEl, key;
        ...
        gj..methods.renderDisplayElement($, $displayEl, column, record, id, mode);
            ...
            for (key in column.events) {
                if (column.events.hasOwnProperty(key)) {
                    $cell.on(key, {
                        ...
                        field: column.field,
                        record: record
                    }, gj..methods.createCellEventHandler(column, column.events[key]));
                }
            }
        }
        if (column.hidden) {
        ...
        gj..events.cellDataBound($, $displayEl, id, column, record);
        return $cell;
    },
    ...
    renderDisplayElement: function($, $displayEl, column, record, id, mode) {
        var text, $checkbox;
        if ('checkbox' === column.type && gj.checkbox) {
            ...
            if ('create' === mode) {
                ...
                $.data().uiLibrary === 'bootstrap' && $displayEl.children('span').addClass('glyphicon');
                column.stopPropagation = true;
            }
        } else if (column.tmpl) {
            text = column.tmpl;
            column.tmpl.replace(/\{(.+?)\}/g, function($0, $1) {
                text = text.replace($0, gj..methods.formatText(record[$1], column));
            });
            $displayEl.html(text);
        } else if (column.renderer && typeof(column.renderer) === 'function') {
            text = column.renderer(record[column.field], record, $displayEl.parent(), $displayEl, id, $);
            if (text) {
                $displayEl.html(text);
            }
        } else {
            record[column.field] = gj..methods.formatText(record[column.field], column);
    ...
    setRecordsData: function($, response) {
        var records = [],
            totalRecords = 0,
            data = $.data();
        if ($.isArray(response)) {
    ...
    createRowClickHandler: function($, id) {
        return function() {
            gj..methods.setSelected($, id, $(this));
        };
    },
    selectRow: function($, data, $row, id) {
        var $checkbox;
        ...
        if ('checkbox' === data.selectionMethod) {
            ...
            if ('multiple' === data.selectionType && $.getSelections().length === $.count(false)) {
                $.find('thead input[data-role="selectAll"]').prop('checked', true);
            }
        }
        return gj..events.rowSelect($, $row, id, $.getById(id));
    },
    unselectRow: function($, data, $row, id) {
        var $checkbox;
        if ($row.attr('data-selected') === 'true') {
            ...
            return gj..events.rowUnselect($, $row, id, $.getById(id));
        }
    },
    setSelected: function($, id, $row) {
        var data = $.data();
        if (!$row || !$row.length) {
            $row = gj..methods.getRowById($, id);
        }
        if ($row) {
            if ($row.attr('data-selected') === 'true') {
                gj..methods.unselectRow($, data, $row, id);
            } else {
                if ('single' === data.selectionType) {
                    $row.siblings('[data-selected="true"]').each(function() {
                        var $row = $(this),
                            id = gj..methods.getId($row, data.primaryKey, $row.data('position'));
                        gj..methods.unselectRow($, data, $row, id);
                    });
                }
                gj..methods.selectRow($, data, $row, id);
            }
        }
        return $;
    },
    selectAll: function($) {
        var data = $.data();
        $.find('tbody tr[data-role="row"]').each(function() {
            var $row = $(this),
                position = $row.data('position'),
                record = $.get(position),
                id = gj..methods.getId(record, data.primaryKey, position);
            gj..methods.selectRow($, data, $row, id);
        });
        $.find('thead input[data-role="selectAll"]').prop('checked', true);
        return $;
    ...
    getSelected: function($) {
        var result = null,
            selections, record, position;
        selections = $.find('tbody>tr[data-selected="true"]');
        if (selections.length > 0) {
            position = $(selections[0]).data('position');
            record = $.get(position);
            result = gj..methods.getId(record, $.data().primaryKey, position);
        }
        return result;
    },
    getSelectedRows: function($) {
        var data = $.data();
        return $.find('tbody>tr[data-selected="true"]');
    },
    getSelections: function($) {
        var result = [],
            position, record,
            data = $.data(),
            $selections = gj..methods.getSelectedRows($);
        if (0 < $selections.length) {
            $selections.each(function() {
                position = $(this).data('position');
                record = $.get(position);
                result.push(gj..methods.getId(record, data.primaryKey, position));
            });
        }
        return result;
    },
    ...
    getRowById: function($, id) {
        ...
        if (position) {
            $result = $.children('tbody').children('tr[data-position="' + position + '"]');
        }
        return $result;
    },
    getByPosition: function($, position) {
        return $.getAll(false)[position - 1];
    },
    ...
    getCell: function($, id, field) {
        var position, $row, $result = null;
        position = gj..methods.getColumnPosition($.data('columns'), field);
        if (position > -1) {
            $row = gj..methods.getRowById($, id);
    ...
    setCellContent: function($, id, field, value) {
        var column, $displayEl = gj..methods.getCell($, id, field);
        if ($displayEl) {
            $displayEl.empty();
            if (typeof(value) === 'object') {
                $displayEl.append(value);
            } else {
                column = gj..methods.getColumnInfo($, field);
                gj..methods.renderDisplayElement($, $displayEl, column, $.getById(id), id, 'update');
            }
        }
    },
    ...
    clear: function($, showNotFoundText) {
        ...
        data.records = [];
        gj..methods.stopLoading($);
        gj..methods.appendEmptyRow($, showNotFoundText ? data.notFoundText : '&nbsp;');
        gj..events.dataBound($, [], 0);
        return $;
    },
    render: function($, response) {
        if (response) {
            gj..methods.setRecordsData($, response);
            gj..methods.updateHeader($);
            gj..methods.loadData($);
        }
        return $;
    },
    filter: function($) {
        ...
        if (data.params[data.paramNames.sortBy]) {
            column = gj..methods.getColumnInfo($, data.params[data.paramNames.sortBy]);
            records.sort(column.sortable.sorter ? column.sortable.sorter(column.direction, column) : gj..methods.createDefaultSorter(column.direction, column.field));
        }
        ...
        gj..events.dataFiltered($, records);
        return records;
    },
    ...
    destroy: function($, keepTableTag, keepWrapperTag) {
        var data = $.data();
        if (data) {
            gj..events.destroying($);
            gj..methods.stopLoading($);
            $.xhr && $.xhr.abort();
            $.off();
            if (keepWrapperTag === false && $.parent('div[data-role="wrapper"]').length > 0) {
                $.unwrap();
            }
            $.removeData();
    ...
    showColumn: function($, field) {
        ...
        if (position > -1) {
            ...
            $.each($.find('tbody>tr'), function() {
                $(this).children('td').eq(position).show();
            });
            data.columns[position].hidden = false;
            $cells = $.find('tbody > tr[data-role="empty"] > td');
            if ($cells && $cells.length) {
                $cells.attr('colspan', gj..methods.countVisibleColumns($));
            }
            gj..events.columnShow($, data.columns[position]);
        }
        return $;
    },
    hideColumn: function($, field) {
        ...
        if (position > -1) {
            ...
            gj..events.columnHide($, data.columns[position]);
        }
        return $;
    },
    ...
    addRow: function($, record) {
        ...
        if (gj..methods.isLastRecordVisible($)) {
            gj..methods.renderRow($, null, record, $.count() - 1);
        }
        gj..events.dataBound($, [record], data.totalRecords);
        return $;
    },
    updateRow: function($, id, record) {
        var $row = gj..methods.getRowById($, id),
            data = $.data(),
            position;
        data.records[$row.data('position') - 1] = record;
        if ($.isArray(data.dataSource)) {
            position = gj..methods.getRecVPosById($, id);
            data.dataSource[position] = record;
        }
        gj..methods.renderRow($, $row, record, $row.index());
        return $;
    },
    removeRow: function($, id) {
        var position,
            data = $.data(),
            $row = gj..methods.getRowById($, id);
        gj..events.rowRemoving($, $row, id, $.getById(id));
        if ($.isArray(data.dataSource)) {
            position = gj..methods.getRecVPosById($, id);
    ...
    count: function($, includeAllRecords) {
        return includeAllRecords ? $.data().totalRecords : $.getAll().length;
    },
    getColumnPositionByRole: function($, role) {
        var i, result, columns = $.data('columns');
        for (i = 0; i < columns.length; i++) {
    ...
    getColumnPositionNotInRole: function($) {
        var i, result = 0,
            columns = $.data('columns');
        for (i = 0; i < columns.length; i++) {
            if (!columns[i].role) {
 ...
 * @plugin Base
 */
gj..widget = function($, jsConfig) {
    var self = this,
        methods = gj..methods;
    /**
     * Reload the data in the 
     ...
     * Clear the content in the 
     ...
     .
     * @method
     * @param {boolean} showNotFoundText - Indicates if the "Not Found" text is going to show after the clearing of the 
     ...
     * Return the number of records in the 
     ...
     . By default return only the records that are visible in the 
     ...
     * @return number
     * @example Local.DataSource <!-- bootstrap, 
     ...
     .pagination -->
     * <button class="btn btn-default" onclick="alert(


     .count())">Count Visible Records</button>
     * <button class="btn btn-default" onclick="alert(


     .count(true))">Count All Records</button>
     * <br/><br/>
     * <table id="
     ...
     *     });
     * </script>
     * @example Remote.DataSource <!-- bootstrap, 
     ...
     * @method
     * @param {object} response - An object that contains the data that needs to be loaded in the 
    ...
    self.render = function(response) {
        return methods.render($, response);
    };
    /**
     * Destroy the 


     . This method remove all data from the 


      and all events attached to the 
     ...
     * @additionalinfo The 
      ...
      table tag and wrapper tag are kept by default after the execution of destroy method,
     ...
     *         
     ...
     .setSelected(parseInt($('#txtNumber').val(), 10));
     *     });
     * </script>
     */
     ...
     * @method
     * @return array
     * @example With.Primary.Ket <!-- checkbox, 
     ...
     *     });
     * </script>
     * @example Without.Primary.Ket <!-- checkbox, 
    ...
    /**
     * Return an array with all records presented in the 
     ...
     * <button onclick="alert(JSON.stringify(
     ...
     .getAll()))" class="btn btn-default">Get All Visible Records</button>
     * <button onclick="alert(JSON.stringify(


     .getAll(true)))" class="btn btn-default">Get All Records</button>
     * <br/><br/>
     * <table id="
     ...
     *         
     ...
     .count(true) + 1, 'Name': 'Test Player', 'PlaceOfBirth': 'Test City, Test Country' });
     *     });
     * </script>
     ...
     *             { field: 'Name' },
     *             { field: 'PlaceOfBirth' },
     *             { width: 100, align: 'center', tmpl: '<i class="material-icons">delete</i>', events: { 'click': function(e) { 
     ...
     *         
     ...
     .updateRow(e.data.id, { 'ID': e.data.id, 'Name': 'Ronaldo', 'PlaceOfBirth': 'Rio, Brazil' });
     *     }
     * </script>
     */
     ...
     * @additionalinfo This method is design to work only with local datasources. If you use remote datasource, you need to send a request to the server to remove the row and then reload the data in the 
    ...
    $.extend($, self);
    if ('' !== $.attr('data-type')) {
        methods.init.call($, jsConfig);
    }
    return $;
}
gj..widget.prototype = new gj.widget();
gj..widget.constructor = gj..widget;
gj..widget.prototype.getConfig = gj..methods.getConfig;
gj..widget.prototype.getHTMLConfig = gj..methods.getHTMLConfig;
(function($) {
    $.fn. = function(method) {
        var $widget;
        if (this && this.length) {
            if (typeof method === 'object' || !method) {
                return new gj..widget(this, method);
            } else {
                $widget = new gj..widget(this, null);
                if ($widget[method]) {
                    return $widget[method].apply(this, Array.prototype.slice.call(arguments, 1));
                } else {
                    throw 'Method ' + method + ' does not exist.';
...
gj..plugins.fixedHeader = {
    config: {
        base: {
             ...
             *     });
             * </script>
             * @example Bootstrap.3.Without.Pager <!-- bootstrap, 
             ...
             *     });
             * </script>
             * @example Bootstrap.3.With.Pager <!-- bootstrap, 
             ...
             *     });
             * </script>
             * @example Bootstrap.4 <!-- bootstrap4, 
    ...
    private: {
        init: function($) {
            var data = $.data(),
                $tbody = $.children('tbody'),
                $thead = $.children('thead'),
                bodyHeight = data.height - $thead.outerHeight() - ($.children('tfoot').outerHeight() || 0);
            $.addClass('gj--scrollable');
        ...
        refresh: function($) {
            var i, width,
                ...
                $tbody = $.children('tbody'),
                $thead = $.children('thead'),
                $tbodyCells = $.find('tbody tr[data-role="row"] td'),
                $theadCells = $.find('thead tr[data-role="caption"] th');
            if ($.children('tbody').height() < gj..plugins.fixedHeader.private.getRowsHeight($)) {
                $tbody.css('width', $thead.outerWidth() + gj..plugins.fixedHeader.private.getScrollBarWidth() + (navigator.userAgent.toLowerCase().indexOf('firefox') > -1 ? 1 : 0));
            } else {
                $tbody.css('width', $thead.outerWidth());
            }
    ...
    public: {},
    events: {},
    configure: function($, fullConfig, clientConfig) {
        $.extend(true, $, gj..plugins.fixedHeader.public);
        var data = $.data();
        if (clientConfig.fixedHeader) {
            $.on('initialized', function() {
                gj..plugins.fixedHeader.private.init($);
            });
            $.on('dataBound', function() {
                gj..plugins.fixedHeader.private.refresh($);
            });
            $.on('resize', function() {
                gj..plugins.fixedHeader.private.refresh($);
            });
...
gj..plugins.expandCollapseRows = {
    config: {
        base: {
             ...
             * You need to specify primaryKey on the initialization of the 


              in order to enable this feature.
             * @default true
             * @example True <!-- bootstrap, 
            ...
            icons: {
                 ...
                 * @example Plus.Minus.Icons <!-- materialicons, 
    ...
    'private': {
        expandDetail: function($, $cell, id) {
            var $contentRow = $cell.closest('tr'),
                $detailsRow = $('<tr data-role="details" />'),
                $detailsCell = $('<td colspan="' + gj..methods.countVisibleColumns($) + '" />'),
                $detailsWrapper = $('<div data-role="display" />'),
                data = $.data(),
                position = $contentRow.data('position'),
                record = $.get(position),
                plugin = gj..plugins.expandCollapseRows;
            if (typeof(id) === undefined) {
                id = gj..methods.getId(record, data.primaryKey, record);
            }
            ...
            $.updateDetails($contentRow);
            plugin.private.keepSelection($, id);
            plugin.events.detailExpand($, $detailsRow.find('td>div'), id);
        },
        collapseDetail: function($, $cell, id) {
            var $contentRow = $cell.closest('tr'),
            ...
            plugin.private.removeSelection($, id);
            plugin.events.detailCollapse($, $detailsRow.find('td>div'), id);
        },
        keepSelection: function($, id) {
            var data = $.data();
        ...
        updateDetailsColSpan: function($) {
            var $cells = $.find('tbody > tr[data-role="details"] > td');
            if ($cells && $cells.length) {
                $cells.attr('colspan', gj..methods.countVisibleColumns($));
            }
        }
    ...
    'public': {
         ...
         * <button onclick="
         ...
         .expandAll()" class="gj-button-md">Expand All</button>
         * <button onclick="


         .collapseAll()" class="gj-button-md">Collapse All</button>
         * <br/><br/>
         * <table id="
        ...
        collapseAll: function() {
            ...
            if (typeof(data.detailTemplate) !== 'undefined') {
                position = gj..methods.getColumnPositionByRole($, 'expander');
                $.find('tbody tr[data-role="row"]').each(function() {
                    gj..plugins.expandCollapseRows.private.collapseDetail($, $(this).find('td:eq(' + position + ')'));
                });
            }
            if (typeof(data.grouping) !== 'undefined') {
                $.find('tbody tr[role="group"]').each(function() {
                    gj..plugins.grouping.private.collapseGroup(data, $(this).find('td:eq(0)'));
                });
            }
            return $;
        },
        ...
        expandAll: function() {
            ...
            if (typeof(data.detailTemplate) !== 'undefined') {
                position = gj..methods.getColumnPositionByRole($, 'expander');
                $.find('tbody tr[data-role="row"]').each(function() {
                    gj..plugins.expandCollapseRows.private.expandDetail($, $(this).find('td:eq(' + position + ')'));
                });
            }
            if (typeof(data.grouping) !== 'undefined') {
                $.find('tbody tr[role="group"]').each(function() {
                    gj..plugins.grouping.private.expandGroup(data, $(this).find('td:eq(0)'));
                });
            }
            return $;
        },
        ...
        updateDetails: function($contentRow) {
            var $ = this,
                ...
                record = $.get($contentRow.data('position'));
            if (record && content) {
                $detailWrapper.html().replace(/\{(.+?)\}/g, function($0, $1) {
                    var column = gj..methods.getColumnInfo($, $1);
                    content = content.replace($0, gj..methods.formatText(record[$1], column));
                });
    ...
    'events': {
         ...
         *     
         ...
         .on('detailExpand', function (e, $detailWrapper, id) {
         *         var record = 
         ...
         * </script>
         */
        detailExpand: function($, $detailWrapper, id) {
            $.triggerHandler('detailExpand', [$detailWrapper, id]);
        },
        /**
         ...
         *     
         ...
         .on('detailCollapse', function (e, $detailWrapper, id) {
         *         $detailWrapper.empty();
         *         alert('detailCollapse is fired.');
         *     });
         * </script>
         */
        detailCollapse: function($, $detailWrapper, id) {
            $.triggerHandler('detailCollapse', [$detailWrapper, id]);
        }
    },
    'configure': function($) {
        var column, data = $.data();
        $.extend(true, $, gj..plugins.expandCollapseRows.public);
        if (typeof(data.detailTemplate) !== 'undefined') {
            column = {
                title: '',
                ...
                events: {
                    'click': function(e) {
                        var $cell = $(this),
                            methods = gj..plugins.expandCollapseRows.private;
                        if ($cell.closest('tr').next().attr('data-role') === 'details') {
                            methods.collapseDetail($, $cell, e.data.id);
                        } else {
                            methods.expandDetail($, $(this), e.data.id);
                        }
                    }
                }
            };
            ...
            $.on('columnShow', function(e, column) {
                gj..plugins.expandCollapseRows.private.updateDetailsColSpan($);
            });
            $.on('columnHide', function(e, column) {
                gj..plugins.expandCollapseRows.private.updateDetailsColSpan($);
            });
            $.on('rowRemoving', function(e, $row, id, record) {
                gj..plugins.expandCollapseRows.private.collapseDetail($, $row.children('td').first(), id);
            });
            $.on('dataBinding', function() {
                $.collapseAll();
            });
            $.on('pageChanging', function() {
                $.collapseAll();
            });
            $.on('dataBound', function() {
                var i, $cell, $row, position, data = $.data();
                if (data.keepExpandedRows && $.isArray(data.expandedRows)) {
                    for (i = 0; i < data.expandedRows.length; i++) {
                        $row = gj..methods.getRowById($, data.expandedRows[i]);
                        if ($row && $row.length) {
                            position = gj..methods.getColumnPositionByRole($, 'expander');
                            $cell = $row.children('td:eq(' + position + ')');
                            if ($cell && $cell.length) {
                                gj..plugins.expandCollapseRows.private.expandDetail($, $cell);
                            }
                        }
                    }
                }
 ...
 */
gj..plugins.inlineEditing = {
    renderers: {
        editManager: function(value, record, $cell, $displayEl, id, $) {
            var data = $.data(),
            ...
            $delete.on('click', function(e) {
                $.removeRow($(this).attr('key'));
            });
            $update.on('click', function(e) {
                $.update($(this).attr('key'));
            });
            $cancel.on('click', function(e) {
                $.cancel($(this).attr('key'));
            });
            $displayEl.empty().append($edit).append($delete).append($update).append($cancel);
        }
    }
};
gj..plugins.inlineEditing.config = {
    base: {
        defaultColumnSettings: {
        ...
        inlineEditing: {
             ...
             *     });
             * </script>
             * @example DateTime <!-- datetimepicker, 
             ...
             */
            mode: 'click',
            /** If set to true, add column with buttons for edit, delete, update and cancel at the end of the 
             ...
             *             $
             ...
             .removeRow($(this).data('key'));
             *         });
             *         $update.on('click', function (e) {
             *             $


             .update($(this).data('key'));
             *             $edit.show();
             *             $delete.show();
             *             $update.hide();
             *             $cancel.hide();
            ...
            */
            ...
            managementColumnConfig: {
                ...
                align: 'center',
                renderer: gj..plugins.inlineEditing.renderers.editManager,
                cssClass: 'gj- - management - column '
            }
        }
    },
    bootstrap: {
...
gj..plugins.inlineEditing.private = {
    localization: function(data) {
        if (data.uiLibrary === 'bootstrap') {
            data.inlineEditing.editButton = '<button role="edit" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> ' + gj..messages[data.locale].Edit + '</button>';
            data.inlineEditing.deleteButton = '<button role="delete" class="btn btn-default btn-sm gj-margin-left-10"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> ' + gj..messages[data.locale].Delete + '</button>';
            data.inlineEditing.updateButton = '<button role="update" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-ok" aria-hidden="true"></span> ' + gj..messages[data.locale].Update + '</button>';
            data.inlineEditing.cancelButton = '<button role="cancel" class="btn btn-default btn-sm gj-margin-left-10"><span class="glyphicon glyphicon-ban-circle" aria-hidden="true"></span> ' + gj..messages[data.locale].Cancel + '</button>';
        } else {
            data.inlineEditing.editButton = '<button role="edit" class="gj-button-md"><i class="gj-icon pencil" /> ' + gj..messages[data.locale].Edit.toUpperCase() + '</button>';
            data.inlineEditing.deleteButton = '<button role="delete" class="gj-button-md"><i class="gj-icon delete" /> ' + gj..messages[data.locale].Delete.toUpperCase() + '</button>';
            data.inlineEditing.updateButton = '<button role="update" class="gj-button-md"><i class="gj-icon check-circle" /> ' + gj..messages[data.locale].Update.toUpperCase() + '</button>';
            data.inlineEditing.cancelButton = '<button role="cancel" class="gj-button-md"><i class="gj-icon cancel" /> ' + gj..messages[data.locale].Cancel.toUpperCase() + '</button>';
        }
    },
    editMode: function($, $cell, column, record) {
        var $displayContainer, $editorContainer, $editorField, value, config, data = $.data();
        if ($cell.attr('data-mode') !== 'edit') {
            if (column.editor) {
                gj..plugins.inlineEditing.private.updateOtherCells($, column.mode);
                    ...
                    if (typeof(column.editor) === 'function') {
                        ...
                        if ('checkbox' === column.type && gj.checkbox) {
                            ...
                            if (data.uiLibrary === 'materialdesign') {
                                $editorField.addClass('gj-textbox-md').css('font-size', $.css('font-size'));
                            }
                            $editorContainer.append($editorField);
                        }
                    }
                    if (data.inlineEditing.mode !== 'command' && column.mode !== 'editOnly') {
                        ...
                        $editorField.on('keyup', function(e) {
                            if (e.keyCode === 13 || e.keyCode === 27) {
                                gj..plugins.inlineEditing.private.displayMode($, $cell, column);
                            }
                        });
                    }
                }
    ...
    displayMode: function($, $cell, column, cancel) {
        ...
        if (column.mode !== 'editOnly') {
            if ($cell.attr('data-mode') === 'edit') {
                ...
                if (cancel !== true && newValue !== record[column.field]) {
                    ...
                    if (column.mode !== 'editOnly') {
                        gj..methods.renderDisplayElement($, $displayContainer, column, record, gj..methods.getId(record, $.data('primaryKey'), position), 'update');
                        if ($cell.find('span.gj-dirty').length === 0) {
                            $cell.prepend($('<span class="gj-dirty" />'));
                        }
                    }
                    gj..plugins.inlineEditing.events.cellDataChanged($, $cell, column, record, newValue);
                    gj..plugins.inlineEditing.private.updateChanges($, column, record, newValue);
                }
    ...
    updateOtherCells: function($, mode) {
        var data = $.data();
        if (data.inlineEditing.mode !== 'command' && mode !== 'editOnly') {
            $.find('div[data-role="edit"]:visible').parent('td').each(function() {
                var $cell = $(this),
    ...
    updateChanges: function($, column, sourceRecord, newValue) {
        var targetRecords, filterResult, newRecord, data = $.data();
        if (!data.guid) {
            data.guid = gj..plugins.inlineEditing.private.generateGUID();
        }
        if (data.primaryKey) {
            targetRecords = JSON.parse(sessionStorage.getItem('gj..' + data.guid));
            if (targetRecords) {
            ...
            sessionStorage.setItem('gj..' + data.guid, JSON.stringify(targetRecords));
        }
    },
...
gj..plugins.inlineEditing.public = {
    /**
     ...
     */
    getChanges: function() {
        return JSON.parse(sessionStorage.getItem('gj..' + this.data().guid));
    },
    /**
    ...
    edit: function(id) {
        var i, record = this.getById(id),
            $cells = gj..methods.getRowById(this, id).children('td'),
            columns = this.data('columns');
        for (i = 0; i < $cells.length; i++) {
            gj..plugins.inlineEditing.private.editMode(this, $($cells[i]), columns[i], record);
        }
        return this;
    },
    /**
    ...
    update: function(id) {
        var i, record = this.getById(id),
            ...
            columns = this.data('columns');
        for (i = 0; i < $cells.length; i++) {
            gj..plugins.inlineEditing.private.displayMode(this, $($cells[i]), columns[i], false);
        }
        gj..plugins.inlineEditing.events.rowDataChanged(this, id, record);
        return this;
    },
    /**
    ...
    cancel: function(id) {
        var i, record = this.getById(id),
            ...
            columns = this.data('columns');
        for (i = 0; i < $cells.length; i++) {
            gj..plugins.inlineEditing.private.displayMode(this, $($cells[i]), columns[i], true);
        }
        return this;
    }
};
gj..plugins.inlineEditing.events = {
    /**
     * Event fires after inline edit of a cell in the 
     ...
     *     
     ...
     .on('cellDataChanged', function (e, $cell, column, record, newValue) {
     *         alert('The value for "' + column.field + '" is changed to "' + newValue + '"');
     *     });
     * </script>
     */
    cellDataChanged: function($, $cell, column, record, oldValue, newValue) {
        $.triggerHandler('cellDataChanged', [$cell, column, record, oldValue, newValue]);
    },
    /**
     * Event fires after inline edit of a row in the 
     ...
     *     
     ...
     .on('rowDataChanged', function (e, id, record) {
     *         alert('Record with id="' + id + '" is changed to "' + JSON.stringify(record) + '"');
     *     });
     * </script>
     */
    rowDataChanged: function($, id, record) {
        $.triggerHandler('rowDataChanged', [id, record]);
    }
};
gj..plugins.inlineEditing.configure = function($, fullConfig, clientConfig) {
    var data = $.data();
    $.extend(true, $, gj..plugins.inlineEditing.public);
    if (clientConfig.inlineEditing) {
        $.on('dataBound', function() {
            $.find('span.gj-dirty').remove();
        });
        $.on('rowDataBound', function(e, $row, id, record) {
            $.cancel(id);
        });
    ...
    if (data.inlineEditing.mode === 'command') {
        gj..plugins.inlineEditing.private.localization(data);
        ...
        $.on('cellDataBound', function(e, $displayEl, id, column, record) {
            if (column.editor) {
                if (column.mode === 'editOnly') {
                    gj..plugins.inlineEditing.private.editMode($, $displayEl.parent(), column, record);
                } else {
 ...
 */
gj..plugins.optimisticPersistence = {
    config: {
        base: {
            optimisticPersistence: {
                /** Array that contains a list with param names that needs to be saved in the localStorage. You need to specify guid on the initialization of the 
                 ...
                 * @example sample <!-- bootstrap, 
                   ...
                   -->
                 * <p>Change the page and/or page size and then refresh the 
                ...
                /** Array that contains a list with param names that needs to be saved in the sessionStorage. You need to specify guid on the initialization of the 
    ...
    private: {
        applyParams: function($) {
            var data = $.data(),
                params = {},
                storage;
            storage = JSON.parse(sessionStorage.getItem('gj..' + data.guid));
            if (storage && storage.optimisticPersistence) {
                $.extend(params, storage.optimisticPersistence);
            }
            storage = JSON.parse(localStorage.getItem('gj..' + data.guid));
            if (storage && storage.optimisticPersistence) {
                $.extend(params, storage.optimisticPersistence);
            }
            $.extend(data.params, params);
        ...
        saveParams: function($) {
            ...
            if (data.optimisticPersistence.sessionStorage) {
                ...
                storage = $.extend(true, JSON.parse(sessionStorage.getItem('gj..' + data.guid)), storage);
                sessionStorage.setItem('gj..' + data.guid, JSON.stringify(storage));
            }
            if (data.optimisticPersistence.localStorage) {
                ...
                storage = $.extend(true, JSON.parse(localStorage.getItem('gj..' + data.guid)), storage);
                localStorage.setItem('gj..' + data.guid, JSON.stringify(storage));
            }
        }
    },
    configure: function($, fullConfig, clientConfig) {
        if (fullConfig.guid) {
            if (fullConfig.optimisticPersistence.localStorage || fullConfig.optimisticPersistence.sessionStorage) {
                gj..plugins.optimisticPersistence.private.applyParams($);
                $.on('dataBound', function(e) {
                    gj..plugins.optimisticPersistence.private.saveParams($);
                });
            }
        }
    }
...
gj..plugins.pagination = {
    config: {
        base: {
            ...
            pager: {
                 ...
                 */
                limit: 10,
                /** Array that contains the possible page sizes of the 
                 ...
                 *     });
                 * </script>
                 * @example Bootstrap.4.FontAwesome <!-- bootstrap4, fontawesome, 
                 ...
                 *     });
                 * </script>
                 * @example Bootstrap.4.Material.Icons <!-- bootstrap4, 
                 ...
                 * table.gj-
                  ...
                  div[data-role="display"] div.custom-item { display: table; margin-right: 5px; }
                 * </style>
                 * <table id="
    ...
    private: {
        init: function($) {
            ...
            if (data.pager) {
                ...
                gj..plugins.pagination.private.localization(data);
                $row = $('<tr data-role="pager"/>');
                $cell = $('<th/>');
                $row.append($cell);
                $leftPanel = $('<div data-role="display" />').addClass(data.style.pager.panel).css({
                    'float': 'left'
                });
                $rightPanel = $('<div data-role="display" />').addClass(data.style.pager.panel).css({
                    'float': 'right'
                });
                $cell.append($leftPanel).append($rightPanel);
                $tfoot = $('<tfoot />').append($row);
                $.append($tfoot);
                gj..plugins.pagination.private.updatePagerColSpan($);
                leftControls = gj..methods.clone(data.pager.leftControls); //clone array
                $.each(leftControls, function() {
                    $leftPanel.append(this);
                });
                rightControls = gj..methods.clone(data.pager.rightControls); //clone array
                $.each(rightControls, function() {
                    $rightPanel.append(this);
                });
                controls = $.find('tfoot [data-role]');
                for (i = 0; i < controls.length; i++) {
                    gj..plugins.pagination.private.initPagerControl($(controls[i]), $);
                }
            }
        },
        localization: function(data) {
            if (data.uiLibrary === 'bootstrap') {
                gj..plugins.pagination.private.localizationBootstrap(data);
            } else if (data.uiLibrary === 'bootstrap4') {
                gj..plugins.pagination.private.localizationBootstrap4(data);
            } else {
                gj..plugins.pagination.private.localizationMaterialDesign(data);
            }
        },
        localizationBootstrap: function(data) {
            var msg = gj..messages[data.locale];
        ...
        localizationMaterialDesign: function(data) {
            ...
            if (typeof(data.pager.rightControls) === 'undefined') {
                data.pager.rightControls = [
                    ...
                    $('<select data-role="page-size" class="gj- - md - limit - select " width="52 "></select></div>'),
                    $('<span class="gj-md-spacer-32">&nbsp;</span>'), $('<span data-role="record-first" class="">0</span>'), $('<span class="">-</span>'), $('<span data-role="record-last" class="">0</span>'), $('<span class="gj- - mdl - pager - label ">' + msg.Of + '</span>'),
                    $('<span data-role="record-total" class="">0</span>'), $('<span class="gj-md-spacer-32">&nbsp;</span>'), $('<button class="gj-button-md">' + (data.icons.previous || msg.Previous) + '</button>').attr('title', msg.PreviousPageTooltip).attr('data-role', 'page-previous').addClass(data.icons.first ? 'gj-button-md-icon' : ''), $('<span class="gj-md-spacer-24">&nbsp;</span>'), $('<button class="gj-button-md">' + (data.icons.next || msg.Next) + '</button>').attr('title', msg.NextPageTooltip).attr('data-role', 'page-next').addClass(data.icons.first ? 'gj-button-md-icon' : '')
                ];
            }
        },
        initPagerControl: function($control, $) {
            var data = $.data();
                ...
                case 'page-size':
                    if (data.pager.sizes && 0 < data.pager.sizes.length) {
                        ...
                        $control.change(function() {
                            ...
                            gj..plugins.pagination.private.changePage($, 1);
                            gj..plugins.pagination.events.pageSizeChange($, newSize);
                        });
        ...
        reloadPager: function($, totalRecords) {
            ...
            if (data.pager) {
                ...
                controls = $.find('TFOOT [data-role]');
                for (i = 0; i < controls.length; i++) {
                    gj..plugins.pagination.private.reloadPagerControl($(controls[i]), $, page, lastPage, firstRecord, lastRecord, totalRecords);
                }
                gj..plugins.pagination.private.updatePagerColSpan($);
            }
        },
        reloadPagerControl: function($control, $, page, lastPage, firstRecord, lastRecord, totalRecords) {
            var newPage;
            switch ($control.data('role')) {
                case 'page-first':
                    gj..plugins.pagination.private.assignPageHandler($, $control, 1, page < 2);
                    break;
                case 'page-previous':
                    gj..plugins.pagination.private.assignPageHandler($, $control, page - 1, page < 2);
                    break;
                case 'page-number':
                    $control.val(page).off('change').on('change', gj..plugins.pagination.private.createChangePageHandler($, page));
                    break;
                case 'page-label-last':
                    $control.text(lastPage);
                    break;
                case 'page-next':
                    gj..plugins.pagination.private.assignPageHandler($, $control, page + 1, lastPage === page);
                    break;
                case 'page-last':
                    gj..plugins.pagination.private.assignPageHandler($, $control, lastPage, lastPage === page);
                    break;
                case 'page-button-one':
                    newPage = (page === 1) ? 1 : ((page == lastPage) ? (page - 2) : (page - 1));
                    gj..plugins.pagination.private.assignButtonHandler($, $control, page, newPage, lastPage);
                    break;
        ...
        assignPageHandler: function($, $control, newPage, disabled) {
            var style = $.data().style.pager;
            if (disabled) {
                ...
                $control.removeClass(style.stateDisabled).prop('disabled', false).off('click').on('click', function() {
                    gj..plugins.pagination.private.changePage($, newPage);
                });
            }
        },
        assignButtonHandler: function($, $control, page, newPage, lastPage) {
            var style = $.data().style.pager;
        ...
        createChangePageHandler: function($, currentPage) {
            return function() {
                var data = $.data(),
        ...
        changePage: function($, newPage) {
            var data = $.data();
            if (gj..plugins.pagination.events.pageChanging($, newPage) !== false && !isNaN(newPage)) {
                $.find('TFOOT [data-role="page-number"]').val(newPage);
                data.params[data.paramNames.page] = newPage;
            }
            $.reload();
        },
        updatePagerColSpan: function($) {
            var $cell = $.find('tfoot > tr[data-role="pager"] > th');
            if ($cell && $cell.length) {
                $cell.attr('colspan', gj..methods.countVisibleColumns($));
            }
        },
    ...
    events: {
         ...
         *     
         ...
         .on('pageSizeChange', function (e, newSize) {
         *         alert('The new page size is ' + newSize + '.');
         *     });
         * </script>
         */
        pageSizeChange: function($, newSize) {
            $.triggerHandler('pageSizeChange', [newSize]);
        },
        /**
         ...
         * @example sample <!-- bootstrap4, fontawesome, dropdown, 
         ...
         *     
         ...
         .on('pageChanging', function (e, newPage) {
         *         if (isNaN(newPage)) {
         ...
         * </script>
         */
        pageChanging: function($, newSize) {
            $.triggerHandler('pageChanging', [newSize]);
        }
    },
    configure: function($, fullConfig, clientConfig) {
        $.extend(true, $, gj..plugins.pagination.public);
        var data = $.data();
        if (clientConfig.pager) {
            gj..methods.isLastRecordVisible = gj..plugins.pagination.private.isLastRecordVisible;
            $.on('initialized', function() {
                gj..plugins.pagination.private.init($);
            });
            $.on('dataBound', function(e, records, totalRecords) {
                gj..plugins.pagination.private.reloadPager($, totalRecords);
            });
            $.on('columnShow', function() {
                gj..plugins.pagination.private.updatePagerColSpan($);
            });
            $.on('columnHide', function() {
                gj..plugins.pagination.private.updatePagerColSpan($);
            });
        }
    }
 ...
 */
gj..plugins.responsiveDesign = {
    config: {
        base: {
            /** The interval in milliseconds for checking if the 
             ...
             *         dataSource: '/Players/Get',
             *         responsive: true,
             *         resizeCheckInterval: 2000, //check if the 


              is resized on each 2 second
             *         columns: [ { field: 'ID', width: 56 }, { field: 'Name' }, { field: 'PlaceOfBirth' } ]
             *     });
             *     
            ...
            /** This setting enables responsive behaviour of the 


             where some column are invisible when there is not enough space on the screen for them.
             ...
             * @type boolean
             * @default false
             * @example Remote.Data.Source <!-- bootstrap, 
             ...
             *     });
             * </script>
             * @example Local.Data.Source <!-- bootstrap, 
            ...
            defaultColumn: {
                 ...
                 * The column is getting invisible when there is not enough space in the 


                  for this minimum width.
    ...
    'private': {
        ...
        updateDetails: function($) {
            ...
            rows = $.find('tbody > tr[data-role="row"]');
            data = $.data();
            for (i = 0; i < rows.length; i++) {
                $row = $(rows[i]);
    ...
    'public': {
         ...
         * Make the 
          ...
          responsive based on the available space.
         * Show column if the space for the 


          is expanding and hide columns when the space for the 
         ...
         * <button onclick="
         ...
         .makeResponsive()" class="gj-button-md">Make Responsive</button>
         * <br/><br/>
         * <table id="
        ...
        makeResponsive: function() {
            var i, $column,
                extraWidth = 0,
                config = this.data(),
                columns = gj..plugins.responsiveDesign.private.orderColumns(config);
    ...
    'events': {
         ...
         * Event fires when the 
          ...
          width is changed. The "responsive" configuration setting should be set to true in order this event to fire.
         *
         * @event resize
         * @param {object} e - event data
         ...
         *     
         ...
         .on('resize', function (e, newWidth, oldWidth) {
         *         alert('resize is fired.');
         *     });
         * </script>
         */
        resize: function($, newWidth, oldWidth) {
            $.triggerHandler('resize', [newWidth, oldWidth]);
        }
    },
    'configure': function($, fullConfig, clientConfig) {
        $.extend(true, $, gj..plugins.responsiveDesign.public);
            ...
            $.on('initialized', function() {
                ...
                $.resizeCheckIntervalId = setInterval(function() {
                    ...
                    if (newWidth !== $.oldWidth) {
                        gj..plugins.responsiveDesign.events.resize($, newWidth, $.oldWidth);
                    }
                    $.oldWidth = newWidth;
                }, fullConfig.resizeCheckInterval);
            });
            $.on('destroy', function() {
                if ($.resizeCheckIntervalId) {
        ...
        if (fullConfig.showHiddenColumnsAsDetails && gj..plugins.expandCollapseRows) {
            $.on('dataBound', function() {
                gj..plugins.responsiveDesign.private.updateDetails($);
            });
            $.on('columnHide', function() {
                gj..plugins.responsiveDesign.private.updateDetails($);
            });
...
gj..plugins.toolbar = {
    config: {
        base: {
            /** Template for the content in the toolbar. Appears in a separate row on top of the 
            ...
            .
              ...
              *         dataSource: '/Players/Get',
              *         uiLibrary: 'bootstrap',
              *         toolbarTemplate: '<div class="row"><div class="col-xs-8" style="line-height:34px"><span data-role="title">


               Title</span></div><div class="col-xs-4 text-right"><button onclick="


              .reload()" class="btn btn-default">click here to refresh</button></div></div>',
              *         columns: [ { field: 'ID', width: 34 }, { field: 'Name' }, { field: 'PlaceOfBirth' } ],
              *         pager: { limit: 5 }
              *     });
              * </script>
            ...
            . Appears in a separate row on top of the 
            ...
            title: undefined,
            style: {
                toolbar: 'gj--md-toolbar'
            }
        },
        bootstrap: {
            style: {
                toolbar: 'gj--bootstrap-toolbar'
            }
        },
        bootstrap4: {
            style: {
                toolbar: 'gj--bootstrap-4-toolbar'
            }
        }
    },
    private: {
        init: function($) {
            ...
            data = $.data();
            $toolbar = $.prev('div[data-role="toolbar"]');
    ...
    public: {
         ...
         * Get or set 
          ...
          title.
         * @additionalinfo When you pass value in the text parameter this value with be in use for the new title of the 
          ...
          object.<br/>
         * When you don't pass value in the text parameter, then the method will return the text of the current 
         ...
         * @method
         * @param {object} text - The text of the new 
         ...
         * <button onclick="
         ...
         .title('New Title')" class="gj-button-md">Set New Title</button>
         * <button onclick="alert(


         .title())" class="gj-button-md">Get Title</button>
         * <br/><br/>
         * <table id="
         ...
         *     var 
         ...
         ({
         *         dataSource: '/Players/Get',
         *         toolbarTemplate: '<div data-role="title">Initial 
    ...
    configure: function($) {
        $.extend(true, $, gj..plugins.toolbar.public);
        $.on('initialized', function() {
            gj..plugins.toolbar.private.init($);
        });
        $.on('destroying', function() {
            $.prev('[data-role="toolbar"]').remove();
        });
    }
};
/** 
...
gj..plugins.resizableColumns = {
    config: {
        base: {
             ...
             *     });
             * </script>
             * @example Bootstrap.4.FixedHeader <!-- bootstrap4, 
    ...
    private: {
        init: function($, config) {
            ...
            $columns = $.find('thead tr[data-role="caption"] th');
            if ($columns.length) {
                for (i = 0; i < $columns.length - 1; i++) {
                    $column = $($columns[i]);
                    $wrapper = $('<div class="gj- - column - resizer - wrapper " />');
                    marginRight = parseInt($column.css('padding-right'), 10) + 3;
                    $resizer = $('<span class="gj- - column - resizer " />').css('margin-right', '-' + marginRight + 'px');
                    $resizer.draggable({
                        start: function() {
                            $.addClass('gj-unselectable');
                            $.addClass('gj- - resize - cursor ');
                        },
                        stop: function() {
                            $.removeClass('gj-unselectable');
                            $.removeClass('gj- - resize - cursor ');
                            this.style.removeProperty('top');
                            this.style.removeProperty('left');
                            this.style.removeProperty('position');
                        },
                        drag: gj..plugins.resizableColumns.private.createResizeHandle($, $column, config.columns[i])
                    });
        ...
        createResizeHandle: function($, $column, column) {
            var data = $.data();
    ...
    public: {},
    configure: function($, fullConfig, clientConfig) {
        $.extend(true, $, gj..plugins.resizableColumns.public);
        if (fullConfig.resizableColumns && gj.draggable) {
            $.on('initialized', function() {
                gj..plugins.resizableColumns.private.init($, fullConfig);
            });
        }
    }
};
    ...
    config: {
        base: {
             ...
             * @example Material.Design <!-- 
             ...
             .rowReorder, draggable, droppable -->
             ...
             * <button onclick="alert(JSON.stringify(
             ...
             .getAll()))" class="gj-button-md">Show Data</button><br/><br/>
             * <table id="
            ...
            style: {
                targetRowIndicatorTop: 'gj- - row - reorder - indicator - top ',
                targetRowIndicatorBottom: 'gj- - row - reorder - indicator - bottom '
            }
        }
    },
    private: {
        init: function($) {
            var i, columnPosition, $row,
                $rows = $.find('tbody tr[data-role="row"]');
            if ($.data('rowReorderColumn')) {
                columnPosition = gj..methods.getColumnPosition($.data('columns'), $.data('rowReorderColumn'));
            }
            for (i = 0; i < $rows.length; i++) {
                $row = $($rows[i]);
                if (typeof(columnPosition) !== 'undefined') {
                    $row.find('td:eq(' + columnPosition + ')').on('mousedown', gj..plugins.rowReorder.private.createRowMouseDownHandler($, $row));
                } else {
                    $row.on('mousedown', gj..plugins.rowReorder.private.createRowMouseDownHandler($, $row));
                }
            }
        },
        createRowMouseDownHandler: function($, $trSource) {
            return function(e) {
                var $dragEl = $.clone(),
                    columns = $.data('columns'),
                    i, $cells;
                ...
                $dragEl.draggable({
                    stop: gj..plugins.rowReorder.private.createDragStopHandler($, $trSource)
                });
                $dragEl.css({
                    position: 'absolute',
                ...
                $trSource.siblings('tr[data-role="row"]').each(function() {
                    ...
                    $dropEl.droppable({
                        over: gj..plugins.rowReorder.private.createDroppableOverHandler($trSource),
                        out: gj..plugins.rowReorder.private.droppableOut
                    });
                });
                ...
                $trSource.siblings('tr[data-role="row"]').each(function() {
                    ...
                    if ($trTarget.droppable('isOver', mousePosition)) {
                        ...
                        if (data.orderNumberField) {
                            ...
                            for (i = 0; i < $rows.length; i++) {
                                $row = $($rows[i]);
                                id = gj..methods.getId($row, data.primaryKey, $row.attr('data-position'));
                                record = gj..methods.getByPosition($, $row.attr('data-position'));
                                $.setCellContent(id, data.orderNumberField, record[data.orderNumberField]);
                            }
                        }
                    }
                    $trTarget.removeClass('gj- - top - border ');
                    $trTarget.removeClass('gj- - bottom - border ');
        ...
        createDroppableOverHandler: function($trSource) {
            return function(e) {
                var $trTarget = $(this),
                    ...
                    sourcePosition = $trSource.data('position');
                if (targetPosition < sourcePosition) {
                    $trTarget.addClass('gj- - top - border ');
                } else {
                    $trTarget.addClass('gj- - bottom - border ');
                }
            };
        },
        droppableOut: function() {
            $(this).removeClass('gj- - top - border ');
            $(this).removeClass('gj- - bottom - border ');
        }
    },
    public: {},
    configure: function($, fullConfig, clientConfig) {
        $.extend(true, $, gj..plugins.rowReorder.public);
        if (fullConfig.rowReorder && gj.draggable && gj.droppable) {
            $.on('dataBound', function() {
                gj..plugins.rowReorder.private.init($);
            });
        }
    }
};
...
gj..plugins.export = {
    ...
    public: {
         ...
         * Get 
          ...
          data in Comma Separated Values (CSV) format.
         * @method
         * @param {boolean} includeAllRecords - include records that are not visible when you are using local dataSource.
         * @return string
         * @example Local.Data <!-- 
         ...
         * <button onclick="alert(
         ...
         .getCSV(true))" class="gj-button-md">Get All</button>
         * <br/><br/>
         * <table id="
         ...
         * <button onclick="alert(
         ...
         .getCSV())" class="gj-button-md">Get CSV</button>
         * <br/><br/>
         * <table id="
         ...
         * <button onclick="
         ...
         .downloadCSV()" class="gj-button-md">Download Only First Page</button>
         * <button onclick="


         .downloadCSV('myfilename.csv', true)" class="gj-button-md">Download All Data</button>
         * <br/><br/>
         * <table id="
         ...
         * <button onclick="
         ...
         .downloadCSV('myfilename.csv')" class="gj-button-md">Download CSV</button>
         * <br/><br/>
         * <table id="
    ...
    configure: function($) {
        $.extend(true, $, gj..plugins.export.public);
    }
};
/** 
 * @widget 
...
gj..plugins.columnReorder = {
    ...
    private: {
        init: function($) {
            var i, $cell,
                $cells = $.find('thead tr th');
            for (i = 0; i < $cells.length; i++) {
                $cell = $($cells[i]);
                $cell.on('mousedown', gj..plugins.columnReorder.private.createMouseDownHandler($, $cell));
                $cell.on('mousemove', gj..plugins.columnReorder.private.createMouseMoveHandler($, $cell));
                $cell.on('mouseup', gj..plugins.columnReorder.private.createMouseUpHandler($, $cell));
            }
        },
        ...
        createMouseUpHandler: function($) {
            return function(e) {
                clearTimeout($.timeout);
                $.data('dragReady', false);
            }
        },
        createMouseMoveHandler: function($, $thSource) {
            return function(e) {
                var $dragEl, srcIndex;
                if ($.data('dragReady')) {
                    $.data('dragReady', false);
                    ...
                    $dragEl.draggable({
                        stop: gj..plugins.columnReorder.private.createDragStopHandler($, $thSource)
                    });
                    $dragEl.css({
                        position: 'absolute',
                    ...
                    $thSource.siblings('th').each(function() {
                        ...
                        $dropEl.droppable({
                            over: gj..plugins.columnReorder.private.createDroppableOverHandler($, $thSource),
                            out: gj..plugins.columnReorder.private.droppableOut
                        });
                    });
                    $dragEl.trigger('mousedown');
                }
        ...
        createDragStopHandler: function($, $thSource) {
            return function(e, mousePosition) {
                $('table[data-role="draggable-clone"]').draggable('destroy').remove();
                $.removeClass('gj-unselectable');
                $thSource.siblings('th').each(function() {
                    var $thTarget = $(this),
                        data = $.data(),
                        targetPosition = gj..methods.getColumnPosition(data.columns, $thTarget.data('field')),
                        sourcePosition = gj..methods.getColumnPosition(data.columns, $thSource.data('field'));
                    $thTarget.removeClass('gj- - left - border ').removeClass('gj - -right - border ');
                    $thTarget.closest('table').find('tbody tr[data-role="row"] td:nth-child(' + ($thTarget.index() + 1) + ')').removeClass('gj- - left - border ').removeClass('gj - -right - border ');
                    if ($thTarget.droppable('isOver', mousePosition)) {
                        ...
                        gj..plugins.columnReorder.private.moveRowCells($, sourcePosition, targetPosition);
        ...
        moveRowCells: function($, sourcePosition, targetPosition) {
            var i, $row, $rows = $.find('tbody tr[data-role="row"]');
            for (i = 0; i < $rows.length; i++) {
                $row = $($rows[i]);
                if (targetPosition < sourcePosition) {
        ...
        createDroppableOverHandler: function($, $thSource) {
            return function(e) {
                var $thTarget = $(this),
                    data = $.data(),
                    targetPosition = gj..methods.getColumnPosition(data.columns, $thTarget.data('field')),
                    sourcePosition = gj..methods.getColumnPosition(data.columns, $thSource.data('field'));
                if (targetPosition < sourcePosition) {
                    $thTarget.addClass('gj--left-border');
                    $.find('tbody tr[data-role="row"] td:nth-child(' + ($thTarget.index() + 1) + ')').addClass('gj--left-border');
                } else {
                    $thTarget.addClass('gj--right-border');
                    $.find('tbody tr[data-role="row"] td:nth-child(' + ($thTarget.index() + 1) + ')').addClass('gj--right-border');
                }
            };
        },
        droppableOut: function() {
    ...
    public: {},
    configure: function($, fullConfig, clientConfig) {
        $.extend(true, $, gj..plugins.columnReorder.public);
        if (fullConfig.columnReorder) {
            $.on('initialized', function() {
                gj..plugins.columnReorder.private.init($);
            });
        }
    }
};
...
gj..plugins.headerFilter = {
    ...
    private: {
        init: function($) {
                ...
                if (data.columns[i].filterable) {
                    ...
                    if ('onchange' === data.headerFilter.type) {
                        $ctrl.on('input propertychange', function(e) {
                            gj..plugins.headerFilter.private.reload($, $(this));
                        });
                    } else {
            ...
            $.children('thead').append($filterTr);
        },
    ...
    events: {},
    configure: function($, fullConfig, clientConfig) {
        $.extend(true, $, gj..plugins.headerFilter.public);
        var data = $.data();
        if (clientConfig.headerFilter) {
            $.on('initialized', function() {
                gj..plugins.headerFilter.private.init($);
            });
        }
    }
};
...
gj..plugins.grouping = {
        ...
        base: {
            ...
            grouping: {
                /** The name of the field that needs to be in use for grouping.
                  ...
                  *     });
                  * </script>
                  * @example Bootstrap.4 <!-- bootstrap4, fontawesome, 
            ...
            icons: {
                 ...
                 * @example Right.Down.Icons <!-- materialicons, 
    ...
    private: {
        init: function($) {
            var previousValue, data = $.data();
            previousValue = undefined;
            $.on('rowDataBound', function(e, $row, id, record) {
                if (previousValue !== record[data.grouping.groupBy] || $row[0].rowIndex === 1) {
                    var colspan = gj..methods.countVisibleColumns($) - 1,
                    ...
                    $expandCollapseCell.on('click', gj..plugins.grouping.private.createExpandCollapseHandler(data));
        ...
        grouping: function($, records) {
            var data = $.data();
            records.sort(gj..methods.createDefaultSorter(data.grouping.direction, data.grouping.groupBy));
        },
        createExpandCollapseHandler: function(data) {
            return function(e) {
                var $cell = $(this),
                    methods = gj..plugins.grouping.private;
    ...
    configure: function($) {
        var column, data = $.data();
        $.extend(true, $, gj..plugins.grouping.public);
        if (data.grouping && data.grouping.groupBy) {
            ...
            data.columns = [column].concat(data.columns);
            $.on('initialized', function() {
                gj..plugins.grouping.private.init($);
            });
            $.on('dataFiltered', function(e, records) {
                gj..plugins.grouping.private.grouping($, records);
            });
        }
    }
};
...
gj.tree.plugins.dragAndDrop = {
    ...
    private: {
        ...
        createNodeMouseMoveHandler: function($tree, $node, $display) {
            return function(e) {
                if ($tree.data('dragReady')) {
                    var data = $tree.data(),
                        $dragEl, $wrapper, offsetTop, offsetLeft;
                    $tree.data('dragReady', false);
                    $dragEl = $display.clone().wrap('<div data-role="wrapper"/>').closest('div').wrap('<li class="' + data.style.item + '" />').closest('li').wrap('<ul class="' + data.style.list + '" />').closest('ul');
                    $('body').append($dragEl);
        ...
        createDragStopHandler: function($tree, $sourceNode, $sourceDisplay) {
            ...
            return function(e, mousePosition) {
                var success = false,
                    record, $targetNode, $sourceParentNode, parent;
                ...
                if (!success) {
                    $wrappers.each(function() {
                        var $targetWrapper = $(this),
                            prepend, orderNumber, sourceNodeId;
...
gj.tree.plugins.lazyLoading = {
    ...
    private: {
        ...
        expand: function($tree, $node, id) {
            var ajaxOptions, data = $tree.data(),
                params = {},
                $children = $node.find('>ul>li');
...
gj.editor.config = {
    base: {
         ...
         * If you use Material Design as uiLibrary, then the iconsLibrary is set to Material Icons by default.<br/>
         * The css files for Material Icons or Font Awesome should be manually included to the page where the 
